...
The (heavily annotated) :py:mod:`vc2_quantisation_matrices` module implements
...
.. image:: /_static/lifting_filters.svg
...
.. image:: /_static/classical_filters.svg
...
.. image:: /_static/lifting_z_transform.svg
...
:py:class:`vc2_data_tables.LiftingFilterParameters` into a :math:`2 \times 2`
matrix.
...
.. image:: /_static/matrix_form_formal.svg
...
.. image:: /_static/classical_form_formal.svg
...
.. image:: /_static/matrix_form_formal_decimate_inside.svg
...
.. image:: /_static/noise_gain_accumulation.svg
...
def derive_quantisation_matrix(wavelet_index, wavelet_index_ho, dwt_depth, dwt_depth_ho):
    """
    Derive a noise-power normalising quantisation matrix for the specified
    wavelet transform. This quantisation matrix will seek to cause quantisation
    noise-power to be spread evenly over all wavelet levels and bands.
    ...
    =======
    {level: {band: int, ...}, ...}
        A quantisation matrix, as laid out by the ``quant_matrix`` VC-2
